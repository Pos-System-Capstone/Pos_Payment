...
{
	public class VnPayService : BaseService<VnPayService>, IVnPayServices
	{
		private readonly IConfiguration _configuration;

		public VnPayService(IUnitOfWork<PosPaymentContext> unitOfWork, ILogger<VnPayService> logger, IHttpContextAccessor httpContextAccessor, IConfiguration configuration) : base(unitOfWork, logger, httpContextAccessor)
		{
